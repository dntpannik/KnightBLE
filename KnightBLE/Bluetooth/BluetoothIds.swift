...
class BluetoothIds {
    ...
    public static let acceptedCharacteristics: [CBUUID] = [
        eyeLedCharacteristic, leftGunLedCharacteristic, smokeStackCharacteristic, soundInfoCharacteristic, soundControlCharacteristic
    ]
    
    public static let displayCharacteristics: [CBUUID] = [
        eyeLedCharacteristic, leftGunLedCharacteristic, smokeStackCharacteristic, soundInfoCharacteristic
    ]
