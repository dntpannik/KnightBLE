...
char* randomActionOptionNames = "Horn|Bolt Cannons|Titanic Feet|Ricochet";

bool randomActionsEnabled = false;

int randomActionNumRandomActions = 4;
bool hornActionEnabled = true;
bool boltCannonsActionEnabled = true;
...
static void UpdateRandomActionPeripheral(unsigned long updateMillis) {
  ...
  if (randomActionPeripheralTriggerCharacteristic.written()) {
    ...
    switch(actionValue) {
      case 0:
        ...
        break;
      case 1:
        boltCannonsActionEnabled = !boltCannonsActionEnabled;
        break;
      case 2:
  ...
  if (activeRandomActionIndex == -1 && updateMillis > randomActionNextActionTimeMS && randomActionsEnabled) {
    ...
    if (boltCannonsActionEnabled == true) { numActiveActions += 1; }
    ...
    if (numActiveActions > -1) {
      ...
      if (boltCannonsActionEnabled == true) {
  ...
  switch(activeRandomActionIndex) {
    case 0:
      ...
      break;
    case 1:
      actionActive = PerformBoltCannonsAction(updateMillis);
      break;
    case 2:
