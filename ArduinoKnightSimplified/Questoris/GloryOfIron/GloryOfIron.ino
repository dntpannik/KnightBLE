...
char* togglePeripheralActionNames = "Exhaust";
...
char* ActionPeripheralActionNames = "Horn|Gatling Cannon|Battle Cannon|Las-Impulsor|Thermal Cannon|Reaper Chainsword|MeltaGun|Heavy Stubber|Battle Cannon Stubber|Ironstorm|Stormspear|Twin Icarus Autocannon|Titanic Feet|Ricochet|Explosion";

bool hornActionActive = false;

bool avengerGatlingCannonActionActive = false;
bool rapidFireBattleCannonActionActive = false;
bool lasImpulsorActionActive = false;
bool thermalCannonActionActive = false;
bool reaperChainswordActionActive = false;

bool meltaGunActionActive = false;
bool heavyStubberActionActive = false;
bool battleCannonStubberActionActive = false;

bool ironstormMisslePodActionActive = false;
bool stormspearRocketPodActionActive = false;
bool twinIcarusAutoCannonActionActive = false;
  ...
  if (ActionPeripheralTriggerCharacteristic.written()) {
    ...
    switch(actionValue) {
      case 0: 
        ...
        break;
      case 1:
        avengerGatlingCannonActionActive = true;
        break;
      case 2:
        rapidFireBattleCannonActionActive = true;
        break;
      case 3:
        lasImpulsorActionActive = true;
        break;
      case 4:
        thermalCannonActionActive = true;
        break;
      case 5:
        reaperChainswordActionActive = true;
        break;
      case 6:
        meltaGunActionActive = true;
        break;
      case 7:
        heavyStubberActionActive = true;
        break;
      case 8:
        battleCannonStubberActionActive = true;
        break;
      case 9:
        ironstormMisslePodActionActive = true;
        break;
      case 10:
        stormspearRocketPodActionActive = true;
        break;
      case 11:
        twinIcarusAutoCannonActionActive = true;
        break;
      case 12:
